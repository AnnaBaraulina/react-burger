...
import { TUserActions, IUserInitialState} from '../types/data';
...
export default function userReducer(state = initialState, action: TUserActions): IUserInitialState {
    switch (action.type) {
        ...
        case USER_REGISTER_FORM_SUBMIT: {
            return {
                ...state,
                registrationSubmit: true, //было registerForm
                }
